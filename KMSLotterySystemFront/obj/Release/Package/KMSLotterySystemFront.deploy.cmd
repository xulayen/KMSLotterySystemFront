...
set _DeploySetParametersFile=%RootPath%KMSLotterySystemFront.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%KMSLotterySystemFront.zip" (
echo "%RootPath%KMSLotterySystemFront.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KMSLotterySystemFront.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KMSLotterySystemFront.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KMSLotterySystemFront.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%KMSLotterySystemFront.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%KMSLotterySystemFront.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%KMSLotterySystemFront.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%KMSLotterySystemFront.deploy-readme.txt" (
...
start notepad "%RootPath%KMSLotterySystemFront.deploy-readme.txt"
)
echo =========================================================
goto :eof
